...
class Issue(models.Model):
    ...
    project = models.ForeignKey(
        "tracking.Project", on_delete=models.CASCADE, related_name="issues"
    )
    author_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="author_issues"
    )
...
class Comment(models.Model):
    ...
    issue = models.ForeignKey(
        "tracking.Issue", on_delete=models.CASCADE, related_name="comments"
    )
...
class Contributor(models.Model):
    ...
    project = models.ForeignKey(
        "tracking.Project", on_delete=models.CASCADE, related_name="contributors"
    )
